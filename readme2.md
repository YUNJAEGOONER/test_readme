...
| 설명                                                         | 이미지                                                       |
|------------------------------------------------------------|------------------------------------------------------------|
| 아이디/비밀번호로 인증되도록 설정했습니다. 회원가입으로 회원을 등록할 수 있고, 로그인 버튼을 통해 로그인할 수 있습니다. 로그인 시, 홈 화면으로 이동합니다. | ![아이디-비밀번호](https://github.com/user-attachments/assets/7bc86b69-ac19-4872-9382-cbd5c6a3aeb2) |
| 회원가입은 아이디, 비밀번호, 비밀번호 확인, 이메일로 구성됩니다. 비밀번호가 일치하지 않으면 오류가 발생하며 나머지 입력값에 대해서도 유효성을 검사합니다. | ![유효](https://github.com/user-attachments/assets/effc1e5e-febd-4188-af68-8319db3158de) |
|홈 화면에서 인기 게시글과 일정을 확인할 수 있습니다. 상/하단에 내비게이션 바를 추가하여 다른 기능으로 쉽게 이동할 수 있습니다.| ![홈화면](https://github.com/user-attachments/assets/c8e75172-f187-4556-94d9-1f88d6eedf57) |
|마이 페이지에서 내가 쓴 글을 조회할 수 있습니다. 회원 가입 시 사용했던 아이디와 이메일을 볼 수 있습니다.| ![마이페이](https://github.com/user-attachments/assets/c4100131-3b77-4e48-8b6e-5fd764034bd1) |
|전체 게시글을 조회할 수 있고 검색을 통해 글을 찾을 수 있습니다.| ![전체글](https://github.com/user-attachments/assets/3eefcd6e-4f6d-400e-9567-2480fbb98143) |
